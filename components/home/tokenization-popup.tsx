...
export function TokenizationPopup() {
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => !v && handleClose()}>
      <DialogPortal>
        <DialogOverlay />
        <DialogPrimitive.Popup className="fixed top-1/2 left-1/2 z-50 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl mx-4 overflow-hidden rounded-xl bg-background ring-1 ring-foreground/10 shadow-2xl data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 duration-150">
          <div className="flex flex-col sm:flex-row min-h-[340px]">
            ...
            <div className="flex flex-col justify-center px-6 py-7 sm:px-8 sm:w-1/2 gap-4">
              ...
              <p className="text-[10px] text-muted-foreground/60 leading-relaxed">
                By continuing, you may receive updates about investment
                opportunities.
              </p>
            </div>
          </div>
